class Admin::CostcsController < ApplicationController
  ...
  def create
    ...
    if @costc.save
      ...
      redirect_to admin_costcs_path, notice: 'Centro de costos creado satisfactoriamente' 
    else
  ...
  def destroy
    @costc.destroy
    respond_to do |format|
      format.html { redirect_to admin_costcs_path, notice: 'Centro de costos eliminado satisfactoriamente' }
    end
  end
